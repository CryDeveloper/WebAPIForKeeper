...
namespace WebAPIForKeeper.Models
{
    public class Struct
    {
        public Struct(DateTime start_Date, DateTime? end_Date, string target, string name_Departament, string surnameEmp, string firstnameEmp, string patronymicEmp, string firstname, string surname, string patronymic, string telephone, string email, string organization, string value, DateTime? birthday, int? seria, int? number)
        {
            ...
            Departament departament = BaseConnect.baseModel.Departament.FirstOrDefault(x => x.Name_Departament == Name_Departament);
